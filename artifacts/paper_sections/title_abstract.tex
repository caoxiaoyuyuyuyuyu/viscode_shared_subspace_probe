...
However, a code-naive ablation (Llama-3-8B) shows this failure mode is itself code-pretraining-specific: visual cross-format CKA persists without code pretraining (21/21 cells $p < 0.005$), while python--visual entanglement does not (20/21 cells $p > 0.05$).
