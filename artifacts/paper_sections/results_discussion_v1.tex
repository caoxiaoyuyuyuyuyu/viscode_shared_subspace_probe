...
(2)~python--visual entanglement differs in statistical detectability: Qwen family python-X cells reach significance in 9/21 cells (min-$p<0.05$, uncorrected), whereas Llama-3-8B achieves only 1/21.
