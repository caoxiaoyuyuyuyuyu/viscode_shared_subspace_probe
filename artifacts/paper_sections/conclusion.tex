...
(iv)~a pre-registered non-visual Python negative control (D060) formally fails: python code yields 60--110\% of the visual CKA across 20/21 evaluation cells, establishing that code-general structure---rather than visual-specific representations---dominates the measured alignment; a code-naive ablation (Llama-3-8B, Appendix~\ref{sec:llama-baseline}) further constrains this as a permutation-detectability phenomenon rather than a magnitude effect.
