...
This constitutes a quantitative split in extent rather than a qualitative split in presence, and suggests that the C1 failure mode (python yielding 60--110\% of visual CKA in code-pretrained models) is specific to code-pretrained LLMs, not a general property of language models.
