...
Visual cross-format CKA is significant at all 21 cells ($p \leq 0.0024$), with magnitudes comparable to the Qwen family (mean 0.116 vs.\ Qwen 0.119--0.154).
...
We note that the equidistant protocol samples Llama-3 to L28 (87.5\% depth), missing the final layers where D075's three-layer scan found the only two significant python cells (L31, 97\% depth).
This suggests python--visual entanglement in code-naive models, if present, may be confined to the deepest layers.
